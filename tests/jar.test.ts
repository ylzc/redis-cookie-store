...
describe('get set cookies jar', () => {
    ...
    async function prepare() {
        ...
        await Promise.all(randomCookies.map(it => jar.setCookie(it, 'https://www.baidu.com')));
    ...
    test('should get 1 cookies from jar', async () => {
        ...
        const res = await jar.getCookies('https://www.baidu.com');
    ...
    test('should get 10 cookies from jar', async () => {
        ...
        const cookies1 = await jar.getCookies('https://www.baidu.com');
